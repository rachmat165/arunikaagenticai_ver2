...
OPENROUTER_MODEL_GROUPS: dict[str, dict] = {
    ...
    "gemini": {
        ...
        "models": {
            ...
            # ── Alias Latest ────────────────────────────────────────────────
            "~google/gemini-flash-latest":                 "Gemini Flash (Latest alias)",
            "~google/gemini-pro-latest":                   "Gemini Pro (Latest alias)",
            # ── Gemma Open Source ───────────────────────────────────────────
            "google/gemma-4-31b-it:free":                  "Gemma 4 31B 🆓 GRATIS",
            "google/gemma-4-31b-it":                       "Gemma 4 31B",
            "google/gemma-4-26b-a4b-it:free":              "Gemma 4 26B A4B 🆓 GRATIS",
